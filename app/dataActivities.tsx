...
import { Ionicons, FontAwesome, FontAwesome6, FontAwesome5, MaterialCommunityIcons } from "@expo/vector-icons";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.infoCards}>
        <View style={styles.card}>
          <MaterialCommunityIcons style={styles.icon} name="clock" size={30} color="#000" />
        ...
        <View style={styles.card}>
          <FontAwesome6 style={styles.icon} name="fire-flame-curved" size={30} color="#000" />
        <View style={styles.cardContent}>
